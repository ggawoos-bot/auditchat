...
export class QuestionAnalyzer {
  ...
  private async analyzeWithModel(question: string, model: string, apiKey: string): Promise<QuestionAnalysis> {
    ...
    const chat = ai.chats.create({
      model: model,
      config: {
        systemInstruction: 'You are an expert assistant for analyzing Korean questions about internal audit policies, procedures, and regulations.'
      },
      history: [],
    });
...
다음 형식으로 분석해주세요:
{
  "intent": "질문의 의도 (예: 내부감사 절차 문의, 규정 내용 확인 등)",
  "keywords": ["핵심 키워드 배열"],
...
1. 조사가 붙은 단어에서 원형 단어를 추출하세요
   - 예: "감사보고서에서 위반사항" → keywords: ["감사보고서", "위반사항"] (조사 "에서" 제거)
   - 예: "내부감사에서 발견되면" → keywords: ["내부감사", "발견"] (조사 "에서", "면" 제거)
   - 예: "재무제표에서 오류가 있으면" → keywords: ["재무제표", "오류"] (조사 제거)
...
- 내부감사: 감사, 내부감사, 감사활동, 감사팀, 감사부서, 감사위원회
- 감사보고서: 감사결과보고서, 감사의견, 지적사항, 시정조치, 개선권고
- 위반사항: 위반, 위배, 불법행위, 부정행위, 규정위반, 부적정
- 내부통제: 통제활동, 통제절차, 리스크관리, 위험관리, 통제환경
- 재무제표: 회계자료, 재무자료, 결산자료, 장부, 계정과목
- 법령: 법규, 규정, 조항, 법률, 시행령, 시행규칙
- 절차: 절차, 프로세스, 단계, 흐름, 업무흐름, 처리절차
- 증빙자료: 증빙, 근거자료, 첨부자료, 관련서류, 파일, 문서
- 시정조치: 개선조치, 보완조치, 시정명령, 권고사항, 이행계획
- 제재: 벌금, 과태료, 징계, 처벌, 제재조치

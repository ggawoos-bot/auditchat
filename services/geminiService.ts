...
15. For source citations in tables, use appropriate reference format based on document type:
    - LEGAL DOCUMENTS (법령): Use specific law type with article references (조항)
      * "공공감사에 관한 법률 제1조" for 공공감사에 관한 법률(법률)(제21066호)(20251001) (법률 조항)
      * "공공감사에 관한 법률 시행령 제1조제1항" for 공공감사에 관한 법률 시행령(대통령령)(제34369호)(20240527) (시행령 조항)
      * "공공기관의 운영에 관한 법률 제1조" for 공공기관의 운영에 관한 법률(법률)(제20400호)(20240927) (법률 조항)
      * "공공기관의 운영에 관한 법률 시행령 제1조제1항" for 공공기관의 운영에 관한 법률 시행령(대통령령)(제33078호)(20230101) (시행령 조항)
      * "공공기관의 회계감사 및 결산감사에 관한 규칙 제1조" for 공공기관의 회계감사 및 결산감사에 관한 규칙(감사원규칙)(제00378호)(20241226) (규칙 조항)
      * "국가를 당사자로 하는 계약에 관한 법률 시행령 제1조제1항" for 국가를 당사자로 하는 계약에 관한 법률 시행령(대통령령)(제35811호)(20251001) (시행령 조항)
    - NON-LEGAL DOCUMENTS (일반문서): Use simplified document names with page references
      * "공공감사에관한 법률의 이해, p.7" for 공공감사에관한 법률의 이해
      * "기타공공기관 계약사무 운영규정, p.2" for 기타공공기관 계약사무 운영규정(기획재정부훈령)(제729호)(20240927)
...
22. 답변 지침:
    ...
    - 예시: "질문: 내부감사 결과, 특정 지출은 관련 규정에 부적정하게 집행되었습니다."
      * ❌ 잘못된 답변: "네, 내부감사 결과, 특정 지출은 관련 규정에 부적정하게 집행되었습니다."
      * ✅ 올바른 답변: 
        "[조건 정리]
        1. 내부감사 결과, 특정 지출은 관련 규정에 부적정하게 집행되었습니다.
        [각 경우 설명과 근거]
        ... (조건별 상세 설명)
        [결론 요약]
        따라서 내부감사 결과, 특정 지출은 관련 규정에 부적정하게 집행되었습니다."
...
- Example: "내부감사 결과, 특정 지출은 관련 규정에 부적정하게 집행되었습니다 **1 2**."
...
23. Format the 참조문서 section (only when needed) as follows:
    ### 참조문서
    - **공공감사에 관한 법률**: 공공감사에 관한 법률(법률)(제21066호)(20251001) - 제1조, 제3조, 제5조
    - **공공감사에 관한 법률 시행령**: 공공감사에 관한 법률 시행령(대통령령)(제34369호)(20240527) - 제1조제1항, 제2조제2항
    - **공공기관의 운영에 관한 법률**: 공공기관의 운영에 관한 법률(법률)(제20400호)(20240927) - 제1조, 제3조, 제5조
    - **공공기관의 운영에 관한 법률 시행령**: 공공기관의 운영에 관한 법률 시행령(대통령령)(제33078호)(20230101) - 제1조제1항, 제2조제2항
    - **공공기관의 회계감사 및 결산감사에 관한 규칙**: 공공기관의 회계감사 및 결산감사에 관한 규칙(감사원규칙)(제00378호)(20241226) - 제1조, 제3조
    - **국가를 당사자로 하는 계약에 관한 법률 시행령**: 국가를 당사자로 하는 계약에 관한 법률 시행령(대통령령)(제35811호)(20251001) - 제1조제1항, 제2조제2항
    - **공공감사에관한 법률의 이해**: 공공감사에관한 법률의 이해 - p.1, p.2, p.3
    - **기타공공기관 계약사무 운영규정**: 기타공공기관 계약사무 운영규정(기획재정부훈령)(제729호)(20240927) - p.2, p.4, p.6
...
---END OF SOURCE---`;
  ...
  private getDocumentType(filename: string): 'legal' | 'guideline' {
    // 감사 도메인 기준: 법률/시행령/규칙이 포함된 파일명은 법령 문서로 분류
    if (
      filename.includes('법률') ||
      filename.includes('시행령') ||
      filename.includes('규칙')
    ) {
      return 'legal'; // 법령 문서 (법률, 시행령, 규칙 등)
    }
    return 'guideline'; // 업무지침, 매뉴얼, 해설서, 운영규정 등
  }
  ...
  private async initializeWithBackgroundPreloading(): Promise<void> {
    ...
    const isDevelopment = typeof window !== 'undefined' && 
      (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1');
    const PDF_BASE_URL = isDevelopment ? '/pdf/' : '/auditchat/pdf/';
